...
- Preserve one global FIFO timeline across steering and follow-up rows, stable item IDs, image attachments, and exact failed-dispatch restoration; normal delivery never lets a later row overtake the head because it uses the other lane.
